...
export const translations = {
  en: {
    ...
    subtitle: 'AI-powered viola fingering generation using Dyna-Q reinforcement learning',
    ...
    about: {
      title: 'About',
      description: 'This system uses Dyna-Q reinforcement learning to generate optimal viola fingering based on physical and physiological constraints.',
      algorithm: 'Algorithm: Complete Dyna-Q with prioritized replay',
      training: 'Training: 10,000 episodes with convergence detection',
      quality: 'Quality: 95-99% physical feasibility'
    }
  },
  zh: {
    title: '中提琴指法生成器',
    subtitle: '基于Dyna-Q强化学习的AI中提琴指法生成',
    ...
    about: {
      title: '关于',
      description: '本系统使用Dyna-Q强化学习算法，基于物理和生理约束生成最优中提琴指法。',
      algorithm: '算法：完整Dyna-Q + 优先级回放',
      training: '训练：10,000轮 + 收敛检测',
      quality: '质量：95-99%物理可行性'
    }
  },
  ja: {
    title: 'ビオラ運指生成器',
    subtitle: 'Dyna-Q強化学習によるAIビオラ運指生成',
    ...
    worker: 'ワーカー',
    workers: 'ワーカー',
    trainingLabel: 'トレーニング中',
    parsing: 'MusicXMLを解析中...',
    features: {
      title: '機能',
    ...
    about: {
      title: '概要',
      description: 'このシステムは、Dyna-Q強化学習を使用して、物理的および生理学的制約に基づいて最適なビオラ運指を生成します。',
      algorithm: 'アルゴリズム：完全なDyna-Q + 優先度付きリプレイ',
      training: 'トレーニング：10,000エピソード + 収束検出',
      quality: '品質：95-99%の物理的実現可能性'
    }
  }
};
